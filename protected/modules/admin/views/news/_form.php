...
<div class="form">
    ...
    <div class="form-group">
        <div class="col-sm-4">
            <div class="col-sm-12">
                <?php echo $form->labelEx($model, 'idmenu', array('class' => 'control-label pull-left')); ?>
            </div>
            <div class="col-sm-12">
                <?php echo $form->error($model, 'idmenu'); ?>
                <?php echo $form->dropDownList($model, 'idmenu', Menu::model()->getChildsMenu(), array('class' => 'form-control')); ?>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textField($model, 'title', array('size' => 60, 'maxlength' => 255, 'class' => 'form-control', 'placeholder' => 'Tiêu đề danh mục...')); ?>
            </div> 
        </div>
        <div class="col-sm-4">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textField($model, 'alias', array('readonly' => 'readonly', 'size' => 60, 'maxlength' => 255, 'class' => 'form-control', 'placeholder' => 'Địa chỉ URL...')); ?>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textArea($model, 'summary', array('rows' => 6, 'cols' => 50, 'class' => 'form-control', 'placeholder' => 'Thông tin trích dẫn...')); ?>
            </div> 
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textArea($model, 'content', array('id' => 'content-news', 'rows' => 6, 'cols' => 50, 'class' => 'form-control', 'placeholder' => 'Nội dung...')); ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-6">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textField($model, 'image', array('style' => 'cursor: pointer', 'readonly' => 'readonly', 'onclick' => 'openKCFinder(this)', 'size' => 60, 'maxlength' => 64, 'class' => 'form-control', 'placeholder' => 'Click vào để chọn hình đại diện tin...')); ?>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textField($model, 'source', array('size' => 50, 'maxlength' => 50, 'class' => 'form-control', 'placeholder' => 'Tên người đăng tin hoặc Nguồn thông tin...')); ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-6">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textArea($model, 'seodescription', array('rows' => 6, 'cols' => 50, 'class' => 'form-control', 'placeholder' => 'Đoạn thông tin mô tả bài viết dùng cho SEO...')); ?>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <?php echo $form->textArea($model, 'seokeyword', array('rows' => 6, 'cols' => 50, 'class' => 'form-control', 'placeholder' => 'Từ khóa bài viết dùng cho SEO...')); ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-12 text-center">
            <?php echo CHtml::submitButton($model->isNewRecord ? 'Đăng tin' : 'Save', array('class' => 'btn btn-primary btn-xs')); ?>
