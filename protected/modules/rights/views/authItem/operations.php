...
<div id="operations">
    ...
    <h3 class="text-primary"><?php echo Rights::t('core', 'Thao tác'); ?></h3>

    <p><code>
            <?php echo Rights::t('core', 'Là sự phân quyền cho phép thực hiện một thao tác(operations) đơn lẻ.'); ?><br />
        </code></p>

    <p class="btn btn-xs alert-warning">
        <?php
        echo CHtml::link(Rights::t('core', '<i class="fa fa-plus-circle"></i> Tạo thêm thao tác'), array('authItem/create', 'type' => CAuthItem::TYPE_OPERATION), array(
    ...
    <div class="well">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'emptyText' => Rights::t('core', 'Không tồn tại thao tác'),
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'name',
                    'header' => Rights::t('core', 'Tên thao tác'),
                    'type' => 'raw',
