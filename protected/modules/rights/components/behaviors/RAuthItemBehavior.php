...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
	...
	{
		return CHtml::linkButton(Rights::t('core', '<b style="color:#ff0000;">Delete</b>'), array(
	...
	*/
	...
	{
		return CHtml::linkButton(Rights::t('core', '<b style="color:#ff0000;">Remove</b>'), array(
	...
	*/
	...
	{
		return CHtml::linkButton(Rights::t('core', '<b style="color:#ff0000;">Hủy bỏ</b>'), array(
	...
	*/
	public function getRevokePermissionLink(CAuthItem $role)
	{
		...
		return CHtml::link(Rights::t('core', '<b style="color:#ff0000;">Hủy bỏ</b>'), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getAssignPermissionLink(CAuthItem $role)
	{
		...
		return CHtml::link(Rights::t('core', '<b style="color:#0000ff;">Thêm vào</b>'), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getInheritedPermissionText($parents, $displayType=false)
	{
		...
		return '<span class="inherited-item" title="'.implode('<br />', $items).'">'.Rights::t('core', 'Thừa hưởng').' *</span>';
	}
}
