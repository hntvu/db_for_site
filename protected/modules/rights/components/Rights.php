...
class Rights
{
	...
	*/
	...
	{
		return array(
			CAuthItem::TYPE_OPERATION=>Rights::t('core', 'Thao tác'),
			CAuthItem::TYPE_TASK=>Rights::t('core', 'Chỉ định'),
			CAuthItem::TYPE_ROLE=>Rights::t('core', 'Vai trò'),
		);
	}
	...
	*/
	public static function getAuthItemTypeNamePlural($type)
	{
		switch( (int)$type )
		{
			case CAuthItem::TYPE_OPERATION: return Rights::t('core', 'Thao tác');
			case CAuthItem::TYPE_TASK: return Rights::t('core', 'Chỉ định');
			case CAuthItem::TYPE_ROLE: return Rights::t('core', 'Vai trò');
	...
	*/
	...
	{
		$module = self::module();
		return 'Secured with <a href="#" rel="external">Rights</a> version '.$module->getVersion().'.';
	}
