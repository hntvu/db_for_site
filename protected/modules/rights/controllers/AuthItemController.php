...
class AuthItemController extends RController {
    ...
    public function actionPermissions() {
        ...
        $columns = array(
            ...
            array(
                'name' => 'description',
                'header' => Rights::t('core', 'Loại quyền'),
                'type' => 'raw',
                'htmlOptions' => array(
        ...
        if (isset($_POST['GenerateForm']) === true) {
            ...
            if ($model->validate() === true) {
                ...
                if (($generatedItems = $generator->run()) !== false && $generatedItems !== array()) {
                    Yii::app()->getUser()->setFlash($this->module->flashSuccessKey, Rights::t('core', '<i class="alert-success">Loại quyền đã được tạo thành công</i>')
                    );
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['AuthItemForm']) === true) {
            ...
            if ($formModel->validate() === true) {
                ...
                Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('core', ':name created.', array(':name' => $item->getNameText()))
                );
    ...
    public function actionDelete() {
        ...
        if (Yii::app()->request->isPostRequest === true) {
            ...
            Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('core', ':name deleted.', array(':name' => $item->getNameText()))
            );
    ...
    public function actionRemoveChild() {
        ...
        if (Yii::app()->request->isPostRequest === true) {
            ...
            Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('core', 'Child :name removed.', array(':name' => $child->getNameText()))
            );
    ...
    public function loadModel() {
        if ($this->_model === null) {
            ...
            if ($this->_model === null)
                throw new CHttpException(404, Rights::t('core', 'Trang bạn yêu cầu không tồn tại'));
        }
