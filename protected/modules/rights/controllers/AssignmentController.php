...
class AssignmentController extends RController {
        ...
        if ($assignSelectOptions !== array()) {
            ...
            if (isset($_POST['AssignmentForm']) === true) {
                ...
                if ($formModel->validate() === true) {
                    ...
                    Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('core', '<b class="text-success col-lg-12">Quyền :name đã thêm vào.</b>', array(':name' => $item->getNameText()))
                    );
    ...
    public function actionRevoke() {
        ...
        if (Yii::app()->request->isPostRequest === true) {
            ...
            Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('core', '<b class="text-danger col-lg-12">Quyền :name đã hủy bỏ</b>', array(':name' => $item->getNameText()))
            );
