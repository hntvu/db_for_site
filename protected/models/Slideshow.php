...
class Slideshow extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('image, caption, usercreate', 'required'),
            array('usercreate', 'numerical', 'integerOnly' => true),
            array('title, alias, caption', 'length', 'max' => 128),
            array('image', 'length', 'max' => 255),
            array('datecreate, lastupdate', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, alias, image, caption, usercreate, datecreate, lastupdate', 'safe', 'on' => 'search'),
        );
    }
