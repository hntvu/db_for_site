    ...
    public function authenticate($attribute, $params) {
        if (!$this->hasErrors()) {
            ...
            if (!$this->_identity->authenticate()) {
                ...
                if ($failedCount > 5) {
                    $this->addError('password', 'Đăng nhập thất bại! Vui lòng kiểm tra lại tên hoặc mật khẩu');
                }
                //$this->addError('password', 'Đăng nhập thất bại! Vui lòng kiểm tra lại tên hoặc mật khẩu');
            } else
...
//                $this->addError('username', 'Vui lòng kiểm tra lại tên đăng nhập');
//                break;
//            case UserIdentity::ERROR_PASSWORD_INVALID:
//                $this->addError('password', 'Vui lòng kiểm tra lại mật khẩu');
//                break;
//        }
    }
