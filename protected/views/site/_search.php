<div class="indexNews text-justify">
    <div class="row">
        <div class="col-lg-12 col-xs-12">
            <h4><strong><a href="<?php echo Yii::app()->createUrl($data->alias . "-" . substr(hash('sha512', $data->id), 0, 5) . $data->id); ?>" class="post-title"><?php echo Search::highlight($data->title, Yii::app()->user->getState('search')['title']) ?></a></strong></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-xs-12">
